...
public class TabelPesananMenungguPanel extends JPanel {
    ...
    private static final Color HEADER_BG = new Color(251, 146, 60);
    private static final Color ROW_EVEN = new Color(255, 247, 237);
    ...
    private void styleTable() {
        ...
        table.setGridColor(new Color(254, 243, 199));
        table.setIntercellSpacing(new Dimension(1, 1));
        table.setSelectionBackground(new Color(254, 243, 199));
    ...
    public void reloadData() {
        ...
        if (menunggu.isEmpty()) {
            tableModel.addRow(new Object[]{"---", "No waiting orders", "---"});
        } else {
